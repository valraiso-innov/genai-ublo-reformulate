...
import {RiLockLine, RiLockPasswordLine, RiUserLine} from "@remixicon/react";
...
function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      >
        <h2 className="mb-6 text-2xl font-bold text-center text-gray-800 flex items-center justify-center">
          <RiLockLine size={24} className="mr-2 text-blue-600" />
          Se connecter
        </h2>
        <div className="mb-4">
          <label
          ...
          >
            <RiUserLine size={20} className="inline-block mr-1 text-blue-600" />
            Nom d&apos;utilisateur
          </label>
          <input
            type="text"
        ...
        {serverError && (
          <p className="mb-4 text-sm text-center text-red-600">{serverError}</p>
        )}
        <button
          type="submit"
